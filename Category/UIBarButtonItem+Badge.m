...
NSString const *UIBarButtonItem_badgeType = @"UIBarButtonItem_badgeType";
...
-(UILabel*) badge {
    ...
    if(lbl==nil) {
        lbl = [[UILabel alloc] initWithFrame:CGRectMake(self.badgeOriginX, self.badgeOriginY, 16, 16)];
        [self setBadge:lbl];
        [self badgeInit];
