...
- (void)swizzling_layoutSubviews {
    ...
    self.placeholderLabel.frame = CGRectMake(caretRect.origin.x+caretRect.size.width, caretRect.origin.y, CGRectGetWidth(self.bounds)-(caretRect.origin.x+caretRect.size.width)*2, floor(caretRect.size.height));
}
